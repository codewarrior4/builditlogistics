					...
					<div class="row">
						<div class="col-md-5 product-single-gallery">
							<div class="product-slider-container">
								<div class="product-single-carousel owl-carousel owl-theme">
									<div class="product-item">
										<img class="product-single-image" src="{{URL::asset('assets/images/products/zoom/product-1.jpg')}}" data-zoom-image="{{URL::asset('assets/images/products/zoom/product-1-big.jpg')}}"/>
									</div>
									<div class="product-item">
										<img class="product-single-image" src="{{URL::asset('assets/images/products/zoom/product-2.jpg')}}" data-zoom-image="{{URL::asset('assets/images/products/zoom/product-2-big.jpg')}}"/>
									</div>
									<div class="product-item">
										<img class="product-single-image" src="{{URL::asset('assets/images/products/zoom/product-3.jpg')}}" data-zoom-image="{{URL::asset('assets/images/products/zoom/product-3-big.jpg')}}"/>
									</div>
									<div class="product-item">
										<img class="product-single-image" src="{{URL::asset('assets/images/products/zoom/product-4.jpg')}}" data-zoom-image="{{URL::asset('assets/images/products/zoom/product-4-big.jpg')}}"/>
									</div>
								</div>
							...
							<div class="prod-thumbnail owl-dots" id='carousel-custom-dots'>
								<div class="owl-dot">
									<img src="{{URL::asset('assets/images/products/zoom/product-1.jpg')}}"/>
								</div>
								<div class="owl-dot">
									<img src="{{URL::asset('assets/images/products/zoom/product-2.jpg')}}"/>
								</div>
								<div class="owl-dot">
									<img src="{{URL::asset('assets/images/products/zoom/product-3.jpg')}}"/>
								</div>
								<div class="owl-dot">
									<img src="{{URL::asset('assets/images/products/zoom/product-4.jpg')}}"/>
								</div>
							</div>
										...
										<ol class="comment-list">
											<li class="comment-container">
												<div class="comment-avatar">
													<img src="{{URL::asset('assets/images/avatar/avatar1.jpg')}}" width="65" height="65" alt="avatar"/>
											...
											<li class="comment-container">
												<div class="comment-avatar">
													<img src="{{URL::asset('assets/images/avatar/avatar2.jpg')}}" width="65" height="65" alt="avatar"/>
												</div><!-- End .comment-avatar-->
											...
											<li class="comment-container">
												<div class="comment-avatar">
													<img src="{{URL::asset('assets/images/avatar/avatar3.jpg')}}" width="65" height="65" alt="avatar"/>
												</div><!-- End .comment-avatar-->
